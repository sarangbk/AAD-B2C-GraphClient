    ...
    public class Program
    {
        ...
        private static void GetUser(string[] args)
        {
            ...
            try
            {
                ...
                // Initialize the GraphServiceClient.
                GraphServiceClient graphClient = SDKHelper.GetAuthenticatedClient(GraphServiceEndPoint.Users);

                // Get users.
                results.Items = usersService.GetUsers(graphClient).Result;
            }
        ...
        private static void CreateUser(string[] args)
        {
            ...
            string json = System.IO.File.ReadAllText(args[1]);
        ...
        private static void UpdateUser(string[] args)
        {
            ...
            string json = System.IO.File.ReadAllText(args[2]);
